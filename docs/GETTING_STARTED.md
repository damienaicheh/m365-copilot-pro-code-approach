...
This guide covers the prerequisites, Azure authentication, and the initial provisioning of the
Azure resources. Once you are done here, continue with
[DATA_AND_SEARCH.md](./DATA_AND_SEARCH.md) to seed the search index and
[RUN_AND_DEPLOY.md](./RUN_AND_DEPLOY.md) to run or deploy the app.
...
At the **root** of the project, run the following command to provision the Azure resources:
